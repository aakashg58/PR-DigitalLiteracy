		...
		<AuthProvider>
			<Router>
				<Routes>
					...
					<Route path="/techInClassAndWord" element={<TechUsedInClassAndWord />} />
					<Route path="/techSafetyAndPrivacy" element={<TechSafetyAndPrivacy />} />
					<Route path="/financeAndManagement" element={<FinanceAndManagement />} />
