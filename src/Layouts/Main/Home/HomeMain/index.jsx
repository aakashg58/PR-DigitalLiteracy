...
const cardImageList = [cardImage1, cardImage2, cardImage3, cardImage4, cardImage5, cardImage6];

const list1 = ['Apps for different purposes', 'Google Search Techniques', 'Privacy Settings'];
const list2 = ['Microsoft Office Basics', 'Printing and Scanning', 'Email and Document Upload'];
